...
\abstract[Summary]{The core modulation technique Orthogonal Frequency Division Multiplexing (OFDM) is widely integrated in LTE Communication Platform (LTE-R) that supports for intelligent transportation systems (ITS). In such systems, the large Doppler spread is introduced due to the movement of high-speed railway (HSR). Consequently, the orthogonality of subcarriers is destroyed resulting in the inter-carrier interference (ICI). In this paper, we consider a pilot based channel estimation (CE) technique in time domain using the Cubic Hermite interpolation for OFDM systems. We propose a novel pilot structure for high mobility channel to improve the estimation accuracy of channel impulse response (CIR). We then use the estimated channel to compute the CIR channel matrix as well as to cancelate the ICI components of the received signal. To evaluate the performance of the proposed method in the HSR environment, the D2a scenario of the WINNER II channel model has been used. Simulation results show that our proposed technique outperforms the state-of-the-art in terms of channel estimation and ICI cancellation performance.}
...
%
	\begin{figure}
		\centering
		\includegraphics[width=1.0\linewidth]{"figures/figure_3"}
...
\begin{figure}
		\centering
		\includegraphics[width=1.0\linewidth]{figures/figure_4}
...
\begin{figure}
	\centering
	\includegraphics[width=1.0\linewidth]{figures/figure_5}
...
\begin{figure}
	\centering
	\includegraphics[width=1.0\linewidth]{figures/figure_6}
...
\begin{figure}
	\centering
	\includegraphics[width=1.0\linewidth]{figures/figure_7}
...
\begin{figure}
	\centering
	\includegraphics[width=1.0\linewidth]{figures/figure_8}
